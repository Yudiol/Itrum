package com.yudiol.SpringProjection.exception;

import com.yudiol.SpringProjection.exception.errors.BadRequestError;
...
public class GlobalControllerExceptionHandler {
    ...
    @ExceptionHandler
    private ResponseEntity<ApiError> httpMessageNotWritableException(HttpMessageNotWritableException e) {
